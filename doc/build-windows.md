...
Below are some notes on how to build Decon Core for Windows.
...
way. This will install to `c:\workspace\decon`, for example:

    make install DESTDIR=/mnt/c/workspace/decon
