...
This mechanism has been integrated into Bitcore-Node-Decon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/deconpay/insight-api-decon#web-socket-api](https://github.com/deconpay/insight-api-decon#web-socket-api)
* API: [https://github.com/deconpay/insight-api-decon#instantsend-transactions](https://github.com/deconpay/insight-api-decon#instantsend-transactions)
