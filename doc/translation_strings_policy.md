...
This document provides guidelines for internationalization of the Decon Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `decon_en.ts` remains unchanged.
