# Linearize
Construct a linear, no-fork, best version of the Decon blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install decon_hash

https://github.com/deconpay/decon_hash
...
JSON-RPC server. Running `decond` or `decon-qt -server` will be sufficient.
...
* `input`: decond blocks/ directory containing blkNNNNN.dat
