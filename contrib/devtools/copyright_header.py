...
Arguments:
    <base_directory> - The base directory of a Decon Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Decon Core developers'
...
Arguments:
    <base_directory> - The base directory of Decon Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Decon Core repository.
"""
