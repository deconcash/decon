...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5040, "127.0.0.1:5040"));
...
BOOST_AUTO_TEST_CASE(netbase_getgroup)
{
    ...
    BOOST_CHECK(ResolveIP("2002:102:304:5040:5040:5040:5040:5040").GetGroup() == std::vector<unsigned char>({(unsigned char)NET_IPV4, 1, 2})); // RFC3964
    BOOST_CHECK(ResolveIP("2001:0:5040:5040:5040:5040:FEFD:FCFB").GetGroup() == std::vector<unsigned char>({(unsigned char)NET_IPV4, 1, 2})); // RFC4380
    ...
    BOOST_CHECK(ResolveIP("2001:470:abcd:5040:5040:5040:5040:5040").GetGroup() == std::vector<unsigned char>({(unsigned char)NET_IPV6, 32, 1, 4, 112, 175})); //he.net
    BOOST_CHECK(ResolveIP("2001:2001:5040:5040:5040:5040:5040:5040").GetGroup() == std::vector<unsigned char>({(unsigned char)NET_IPV6, 32, 1, 32, 1})); //IPv6
