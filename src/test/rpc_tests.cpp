...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(2099995040504090LL).write() == "20504099.50409990");
    BOOST_CHECK(ValueFromAmount(2099995040504099LL).write() == "20504099.50405040");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20999999.5040999")), 2050405040504090LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20999999.50405040")), 2050405040504099LL);
