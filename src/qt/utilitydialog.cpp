    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  decon-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Decon in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 DECON, 0.01 DECON, 0.1 DECON, 1 DECON and 10 DECON -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.decon.org/en/stable/wallets/deconcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
